    ...
    <div id='home' className='bg-slate-950 text-white h-screen flex flex-col justify-center items-center px-4 relative overflow-hidden'>
      ...
      <div className='text-center space-y-8 z-10 max-w-4xl opacity-0 animate-fade-in'> {/* Fade-in animation for content */}
        ...
        <p className='text-slate-400 text-lg md:text-2xl leading-relaxed max-w-3xl mx-auto animate-fade-in-up animation-delay-1500'>
          3rd Year Information Technology student passionate about <span className='text-white font-bold'>Full Stack Development & UI/UX Design</span>, crafting modern web solutions.
        </p>
        ...
        <div className='flex flex-col md:flex-row gap-6 justify-center items-center pt-6 animate-fade-in-up animation-delay-2000'>
          ...
          <a 
            href="#contact" 
            className='bg-gradient-to-r from-blue-700 to-sky-500 text-white px-10 py-4 rounded-full font-bold text-lg hover:scale-105 transition-all duration-300 shadow-xl shadow-blue-700/40 hover:shadow-sky-500/60'
          >
            Get in Touch
          </a>
          ...
          <a 
            href="#projects" 
            className='bg-transparent border border-blue-600 text-blue-300 px-10 py-4 rounded-full font-bold text-lg hover:border-sky-400 hover:text-sky-400 hover:bg-blue-900/30 transition-all duration-300'
          >
            My Projects
          </a>
